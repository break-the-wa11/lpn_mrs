...
from normflows_1D.flows.base import Flow
from normflows_1D.flows.affine.coupling import AffineCouplingBlock
from normflows_1D.flows.mixing import Invertible1x1Conv
from normflows_1D import nets
...
class GlowBlock(Flow):
    ...
    def __init__(
        ...
        """
        from normflows_1D.flows.normalization import ActNorm

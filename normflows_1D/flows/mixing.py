...
class Invertible1x1Conv(Flow):
    ...
    Assumes 3d input/output tensors of the form BCL
    """
    ...
    def __init__(self, num_channels, use_lu=False):
        ...
        self.use_lu = use_lu
        Q, _ = torch.linalg.qr(torch.randn(self.num_channels, self.num_channels))   #Q orthogonal matrix
        if use_lu:
    ...
    def forward(self, z):
        ...
        W = W.view(self.num_channels, self.num_channels, 1)

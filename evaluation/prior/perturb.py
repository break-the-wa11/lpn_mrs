...
# clean/: clean and no baseline change
# baseline/: clean and baseline change
# low_lipid/: low lipid contamination
# borderline_lipid/: borderline lipid contamination
# high_lipid/: high lipid contamination
...
def perturb_generator(n_samples, perturb_arg, raw_data_dir, save_dir):
    ...
    if perturb_arg['perturb_mode'] in ['clean', 'baseline', 'low_lipid', 'borderline_lipid', 'high_lipid']:
